  ...
  return (
    <>
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="min-w-[146px] px-4 py-3 text-sm rounded-full font-bold bg-green-500 hover:bg-green-400 text-white"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4 flex flex-col py-6">
        {/* removed ,index from (card, key) */}
        {cards.map((card) => (
          <motion.div
            layoutId={`card-${card.title}-${id}`}
            key={`card-${card.title}-${id}`}
            onClick={() => setActive(card)}
            className={`p-4 flex flex-col md:flex-row justify-between items-center bg-white ${shadow_class_from_ui}  hover:bg-blue-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 rounded-xl cursor-pointer
            hover:text-white
            `}
          >
...
export const CloseIcon = () => {
  return (
    <motion.svg
      ...
      className=" text-white bg-red-700 rounded-[50%] p-1 hover:cursor-pointer"
    >
